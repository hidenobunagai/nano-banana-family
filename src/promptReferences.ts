...
export const PROMPT_REFERENCES: PromptReference[] = [
  ...
  },
  {
    ...
    category: "シーン・背景",
    prompt:
      "キャラクターのスタイルを[1970]年代のクラシックな[人物]スタイルに変更してください。\n[長いカーリーヘア]と\n[長い口ひげ]を追加し、\n背景を象徴的な[カリフォルニアの夏の風景]に変更してください。\nキャラクターの顔は変更しないでください。",
    tags: ["その他"],
    author: "",
    caseNumber: 5,
    isPro: false,
  },
  {
    ...
    category: "ポートレート・人物",
    prompt:
      "モデルがピンクのBMWに寄りかかってポーズをとっています。その人は以下のアイテムを身につけており、背景は薄いグレーです。緑色のエイリアンはキーチェーンで、ピンクのハンドバッグに取り付けられています。モデルの肩にはピンクのオウムもいます。隣にはピンクの首輪とゴールドのヘッドフォンをつけたパグが座っています。",
    tags: ["その他"],
    author: "",
    caseNumber: 6,
    isPro: false,
  ...
  },
  {
    ...
    category: "漫画・イラスト",
    prompt:
      "このイラストのコスプレをしている子供の写真を生成してください。背景はコミケに設定してください。",
    tags: ["コスプレ"],
    author: "",
    caseNumber: 11,
    isPro: false,
  ...
  },
  {
    ...
    tags: ["フィギュア", "アイソメトリック", "印刷物", "パッケージ", "プラモデル"],
    author: "",
    caseNumber: 46,
    isPro: false,
  },
  ...
  },
  {
    ...
    tags: ["フィギュア", "ポスター", "ぬいぐるみ", "コスプレ", "パッケージ"],
    author: "",
    caseNumber: 92,
    isPro: false,
  },

...
export function EditorLayout({ children, resultPane }: EditorLayoutProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_360px] xl:grid-cols-[minmax(0,1fr)_440px] gap-4 lg:gap-6 xl:gap-8 items-start w-full max-w-[1400px] mx-auto">

...
export const PROMPT_PRESETS: PromptOption[] = [
  {
    ...
    category: "クリエイティブ",
    prompt:
      "Render a high-resolution photo of a 1/7 scale, fully commercialized figurine featuring the exact person from the uploaded image. Place the collectible on a modern computer desk inside a real-world studio environment with soft key and rim lighting. Keep the sculpt faithful to the original pose and costume, while strictly maintaining the exact facial likeness of the uploaded person. Translate materials into premium painted PVC with subtle weathering. Mount the figure on a round, transparent acrylic base. Show the computer monitor displaying the 3D modeling viewport of this same figurine, and stage a deluxe packaging box beside it featuring flat, illustrated box art inspired by top-tier collectibles. Emphasize tangible materials, lens depth of field, and natural reflections.",
  },
  {
  ...
  },
  {
    ...
    category: "ビジネス",
    prompt:
      "Produce a polished 3x3 grid of square avatar portraits of the exact person from the uploaded image. Keep consistent studio lighting, a soft gradient background, and uniform framing. Vary the hairstyle dramatically in each tile, changing length, color, and styling accessories while strictly preserving the exact facial features, skin tone, and expression continuity of the uploaded person. Output as a single cohesive grid image with thin dividers.",
  },
  {
  ...
  },
  {
    ...
    category: "ファンタジー",
    prompt:
      "Create a hyper-realistic large-format render of the exact person from the uploaded image as a towering giant taking a smartphone selfie in the center of a city square. Surround the figure with dense scaffolding populated by tiny construction workers actively detailing the surface. Fill the environment with modern glass buildings, moving buses and cars, scattered pedestrians, street furniture, and a vibrant blue daylight sky. Maintain photo-real textures on skin, clothing, and infrastructure, with dramatic cinematic lighting and crisp depth of field. The giant's face must be 100% identical to the uploaded photo.",
  },
  {
    id: "retro-platformer",
  ...
  },
  {
    ...
    category: "ビジネス",
    prompt:
      "Generate a professional 2-inch ID portrait cropped from the original image. Center the exact person from the uploaded image from the shoulders up, facing forward with a relaxed, friendly expression. Dress them in formal business attire, tidy hair, and minimal accessories. Use an even, solid blue background with soft studio lighting, no harsh shadows, and crisp focus. The face must remain 100% identical to the uploaded photo.",
  },
  {
    id: "manga-line-art",
    label: "モノクロ漫画線画化",
    category: "クリエイティブ",
    prompt:
      "Convert the source photo into high-contrast black-and-white manga line art. Keep the exact person's facial proportions and likeness 100% accurate from the uploaded image while stylizing with clean inked outlines, controlled hatching, and dynamic screentone shading for volume. Use bold line-weight variation, crisp highlights, and background speed lines or minimal panels that emphasize mood. Avoid grayscale gradients; rely solely on pure black and white.",
  },
  {
    id: "superhero-strip",
  ...
  },
  {
    ...
    category: "クリエイティブ",
    prompt:
      "Craft a premium 1/7 scale collectible diorama of the exact person from the uploaded image displayed inside a clear souvenir glass bottle. Sculpt the figure in a relaxed beach pose surrounded by fine sand, seashells, gentle surf, driftwood, and miniature tropical foliage. Light the scene with warm, directional sunlight casting soft shadows and caustic reflections through the glass. Place the bottle on an elegant wooden base with subtle reflections and maintain sharp, realistic textures on the figure and environment. The face must be 100% identical to the uploaded photo.",
  },
  {
    id: "age-progression",

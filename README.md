...
[▶ Open the interactive diagram](docs/architecture/hide-nb-studio.html) — theme switching, pan/zoom, search, guided views (image-generation flow / identity / guardrails).
